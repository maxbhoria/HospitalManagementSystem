package com.example.hospitalmanagementsystem.doctor.leaves;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.view_previous:
                ...
                Intent i = new Intent(this, View_Leaves.class);
                i.putExtras(b1);
                startActivity(i);
                break;
            default:
                ...
                if (ds1.equals("") || ds2.equals("") || ys1.equals("") || ys2.equals("")) {
                    Message.message(this, "Please Fill in all your Details");
                } else {
                    ...
                    if (b) {
                        Message.message(this, "Application Sent");
                    } else {
                        Message.message(this, "This Application is Already Sent");
                    }
                    dbh.close();
                }
        }
